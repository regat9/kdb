      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <ul>
            ...
            <li><a href="#">Etnies</a></li>
            <li><a href="#">Fila</a></li>
            <li><a href="#">Gucci</a></li>
            <li><a href="#">Hoka</a></li>
            <li><a href="#">New Balance</a></li>
            <li><a href="#">Nike</a></li>
            <li><a href="#">Nocta</a></li>
    ...
    <section class="collab-brands main-list">
      <div class="container-fluid">
        <div class="row">
          <h2>Collab brands</h2>
          <ul>
            <li><a href="#">A Ma Maniere</a></li>
            <li><a href="#">Cactus Jack</a></li>
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <ul>
            ...
            <li><a href="#">Tinker Hatfield</a></li>
          </ul>
        </div>
      </div>
    </section>
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <ul>
            ...
            <li><a href="#">Billie Eillish</a></li>
            <li><a href="#">Lebron James</a></li>
            <li><a href="#">Damian Lillard</a></li>
            <li><a href="#">Travis Scott</a></li>
            <li><a href="#">Klay Thompson</a></li>
            <li><a href="#">Zion Williamson</a></li>
          </ul>
        </div>
      </div>
    </section>
