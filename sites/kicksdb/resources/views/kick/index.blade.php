        ...
        <div class="row">
          ...
          <div class="col-sm-2 col-md-3 col-lg-2 d-none d-md-block">
            <div class="filters">
              ...
              <div class="filters__group">
                <h2>
                  <a href="#" data-bs-toggle="collapse" data-bs-target="#models" aria-expanded="true" aria-controls="bodels">
                    Models
                  </a>
                </h2>
                <ul class="collapse show" id="models">
                    ...
                    <li>
                        <input class="form-check-input" type="checkbox" value="" id="{{ $model->name }}">
